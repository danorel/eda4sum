...
from scripts.utils.operators.get_items_sets import get_items_sets


def by_facet(database_pipeline_cache, model_manager: ModelManager, operator_request: RequestData):
    result = []
    try:
        ...
        if operator_request.weights_mode != None:
            prediction_result = model_manager.get_prediction(result_sets, 
